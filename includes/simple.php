...
#EDIT THE FOLLOWING:
$toAddress = "dasha.minich@gmail.com";  //place your/your client's email address here
$toName = "Dasha Minich"; //place your client's name here
...
?>
	...
	<div>
		<label>
			Name:<br /><input type="text" name="Name" required="required" placeholder="Your Name" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
	</div>
	<div>	
		<label>
	...
	<div><?=$feedback?></div>
    <div class="g-recaptcha" data-sitekey="6Lfl2VQUAAAAAHedZF2l6OtN13YZzSbiXZjghRK6"></div> 
	<div>
